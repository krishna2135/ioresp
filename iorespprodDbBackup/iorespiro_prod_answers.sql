...
CREATE TABLE `answers` (
  ...
  `assigned_test_id` bigint unsigned NOT NULL,
  ...
  `assignedtestschedulemappingid` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `answers_assigned_test_id_foreign` (`assigned_test_id`),
  KEY `answers_question_id_foreign` (`question_id`),
  KEY `answers_choice_id_foreign` (`choice_id`),
  KEY `answers_user_id_foreign` (`user_id`),
  CONSTRAINT `answers_assigned_test_id_foreign` FOREIGN KEY (`assigned_test_id`) REFERENCES `assigned_test` (`id`),
  CONSTRAINT `answers_choice_id_foreign` FOREIGN KEY (`choice_id`) REFERENCES `choices` (`id`),
...
-- Dump completed on 2021-07-13 13:21:58
